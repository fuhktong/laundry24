<section class="laundroworks-mainpic-section laundroworks-pic">
    <div class="laundroworks-mainpic-section-text">
        <h2>Laundroworks</h2>
        <button onclick="window.location.href='index.php?page=contact'">
            Visit Us
        </button>
    </div>
</section>

<div class="laundroworks-text-section">
    <div class="laundroworks-text-section-layer">
        ...
        <div class="laundroworks-feature-section">
    ...
    <div class="laundroworks-img">
        <a href="https://laundroworks.com/">
            <img src="images/laundroworksimg.png" alt="Laundroworks" />
        </a>
    </div>
    <div class="laundroworks-text-section-layer">
        <div class="laundroworks-feature-section">
        ...
        <div class="laundroworks-feature-section">
            ...
            <ul>
                ...
                <li>Receive maintenance updates if a machine becomes unavailable</li>
            </ul>
        </div>
        <div class="laundroworks-feature-section">
