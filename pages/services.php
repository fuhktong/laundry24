<section class="services-mainpic-section services-main-pic">
    <div class="services-mainpic-section-text">
        <h2>Self-Service Washers and Dryers</h2>
        <h1>Attendant On-Site | All New Machines | Free Wi-Fi</h1>
        <button class="services-button" onclick="window.location.href='index.php?page=contact'">
            Visit Us
        </button>
    </div>
</section>
...
<div class="services-text-section">
    <div class="services-text-section-layer">
